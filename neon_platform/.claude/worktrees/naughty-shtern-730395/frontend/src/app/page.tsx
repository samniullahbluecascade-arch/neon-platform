...
import NeonPipelineAnimation from '@/components/NeonPipelineAnimation';
import RatingsShowcase from '@/components/RatingsShowcase';
...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      {/* Pipeline cinematic — logo → design → craft → LOC */}
      <NeonPipelineAnimation />

      {/* Client satisfaction — ratings + testimonials */}
      <RatingsShowcase />
